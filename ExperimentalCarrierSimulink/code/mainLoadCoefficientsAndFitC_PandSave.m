...
load('<output from mainComputeCoefficients');

CX_P = surfit(CX_P, 2, 2);
CY_P = surfit(CY_P, 2, 2);
CZ_P = surfit(CZ_P, 2, 2);

Cl_P = surfit(Cl_P, 2, 2);
Cm_P = surfit(Cm_P, 2, 2);
Cn_P = surfit(Cn_P, 2, 2);
